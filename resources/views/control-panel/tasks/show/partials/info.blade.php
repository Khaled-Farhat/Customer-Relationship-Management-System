<div class="card">
  <div class="card-body d-flex pt-4">
    <div class="col-3 pe-2">
      ...
      <div>
        <x-buttons.anchor :href="route('tasks.edit', $task)" content="Edit task" size="small" color="warning"
          class="my-1" />
        <x-buttons.form :action="route('tasks.destroy', $task)" content="Delete task" size="small" color="danger"
          class="my-1" />
      </div>
    </div>
